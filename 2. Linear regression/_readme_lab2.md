...
начальная популяция: [w0],[w1],[w2],[w3],[w4],[w5],[w6] [w(i)] = w0,w1,w2
особь: [w(i)]
...
формирование нового поколения:
	...
	мутация: вероятность 5% изменения особи рандомной хромосомы (w0 [0-33] w1 (33-66) w2 [66-100]) рандомных 6 генов 
		лучшая особь предыдущего шага не мутирует с вероятность 100% (элитарность)
