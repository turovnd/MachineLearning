...
class OutputMethods(object):
    ...
    def outputTable():
        ...
        k = 15
        data_1, trainDots_1, testDots_1 = DatasetProcessing.getDataset('dataset.txt', "none")
        data_2, trainDots_2, testDots_2 = DatasetProcessing.getDataset('dataset.txt', "none")
        data_3, trainDots_3, testDots_3 = DatasetProcessing.getDataset('dataset.txt', "none")
        data_4, trainDots_4, testDots_4 = DatasetProcessing.getDataset('dataset.txt', "none")
        data_5, trainDots_5, testDots_5 = DatasetProcessing.getDataset('dataset.txt', "none")
        data_6, trainDots_6, testDots_6 = DatasetProcessing.getDataset('dataset.txt', "none")
        data_11, trainDots_11, testDots_11 = DatasetProcessing.getDataset('dataset.txt', "elliptic")
        data_12, trainDots_12, testDots_12 = DatasetProcessing.getDataset('dataset.txt', "elliptic")
        data_13, trainDots_13, testDots_13 = DatasetProcessing.getDataset('dataset.txt', "elliptic")
        data_14, trainDots_14, testDots_14 = DatasetProcessing.getDataset('dataset.txt', "elliptic")
        data_15, trainDots_15, testDots_15 = DatasetProcessing.getDataset('dataset.txt', "elliptic")
        data_16, trainDots_16, testDots_16 = DatasetProcessing.getDataset('dataset.txt', "elliptic")
        data_21, trainDots_21, testDots_21 = DatasetProcessing.getDataset('dataset.txt', "hyperbolic")
        data_22, trainDots_22, testDots_22 = DatasetProcessing.getDataset('dataset.txt', "hyperbolic")
        data_23, trainDots_23, testDots_23 = DatasetProcessing.getDataset('dataset.txt', "hyperbolic")
        data_24, trainDots_24, testDots_24 = DatasetProcessing.getDataset('dataset.txt', "hyperbolic")
        data_25, trainDots_25, testDots_25 = DatasetProcessing.getDataset('dataset.txt', "hyperbolic")
        data_26, trainDots_26, testDots_26 = DatasetProcessing.getDataset('dataset.txt', "hyperbolic")
